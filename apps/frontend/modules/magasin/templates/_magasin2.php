    ...
    <form id="formmesmag" method="post" action="<?php echo url_for('magasin/RetireMagasin') ?>">
<div id="mag_perso" class="mes_mag block col-sm-8 col-sm-offset-2 col-xs-12">
        ...
        <table align="left" class="mag style_police table">
            ...
            foreach ($magasins as $magasin) {
                echo '<tr id="mesmag'.$magasin->getId().'" class="quitter magclick" data-text="'.strtoupper($magasin->getNom()).'">';
                ...
                echo "</td>";
                echo "<td>";
                echo "<input type='checkbox' name='mesmagsel[]' value='".$magasin->getId()."' />";
                echo "</td>";
                echo "<td>";
