...
<div id="menu_connected">
    <div>
        <ul>
            ...
            <li class="<?php echo $idActive==2?'active':'' ?>"><a id="m_Produit" href="<?php echo url_for1('magasin/index') ?>">Produit</a></li>
            <li class="<?php echo $idActive==3?'active':'' ?>"><a id="m_Magasin" href="<?php echo url_for1('produit/index') ?>">Magasin</a></li>
        </ul>
    </div>
</div>